...
[Info_Extraction_Scenario-1.ipynb](https://colab.research.google.com/drive/1a0802LBBCeVTOcKdTdWTzwdr6FxAUXgY#scrollTo=_ocdJzPHGHlj) demonstrates how we evaluated models' capability to extract <ins>unstructured</ins> information from <ins>pdf files</ins> for <ins>internal usage</ins> with FOIA data.
...
[Info_Extraction_Scenario-3.ipynb](https://colab.research.google.com/drive/1AVvMS1jl6j7iuLexYHeYiaB5l3qRCN01?usp=sharing) demonstrates how we evaluated models' capability to extract <ins>structured</ins> information from <ins>images</ins> for <ins>internal usage</ins> with restricted items on Amazon data.
